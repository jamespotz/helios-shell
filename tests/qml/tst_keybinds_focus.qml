...
ShellRoot {
    ...
    Timer {
        ...
        running: true
        onTriggered: {
            if (keybinds.searchFocused) console.warn("KEYBINDS_FOCUS_TEST_PASS");
            else console.error("KEYBINDS_FOCUS_TEST_FAIL: search input lost focus after window focus handoff");
