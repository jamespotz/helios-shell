...
// Neovim, Zed, Bat, Yazi, best-effort Firefox), and dynamic theme generation
// from the current wallpaper via matugen. Colors.qml holds the live palette
// the shell UI binds to; this singleton owns picking one and pushing it in.
QtObject {
    id: root
